...
public class EventLibrary {
    ...
    // effects: for some events have prerequistie, do the check if they are eligible
    // to add into possible events
    ...
    // modifies: ArralList<String> goneThroughEvents
    ...
    // modifies: ArrayList<String> addGoneThroughEvents
    // requires: events never selected or add to this list before, or not in this
    // list(can be deleted)
    ...
    // effects: for events need prerequistie, check if their prerequistie is
    // meet(selected before)
    // public boolean checkGoneThroughEvents(Event event) {
    // if (addGoneThroughEvents(event).contains(event.getEventCode()))
    // return true;
    // else
    // return false;
    // }
